...
import capmarket_optimization as cmmodel
...
class CapacityMarket:
    ...
    def _load_data(self):
        self.data.flow, self.data.df_price_DA, self.data.df_windprodload, self.data.df_zonalsolarproduction, self.data.df_windsolarpen = cmmodel.DayAheadMarket() 
