...
def optimization():
    ...
    return ZonalPrices, GeneratorProduction, LineFlow, LoadShed, WindLoad_df, Rev_Cost_df, network, times, generators, startup_number_df, WindCurtailment, TotalCost_df, zonalwindproduction, zonalsolarproduction