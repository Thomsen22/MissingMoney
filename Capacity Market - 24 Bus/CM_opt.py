...
def DayAheadMarket():
    ...
    df_price, df_genprod, df_flow, df_loadshed, df_windprodload, df_revenuecost, network, times, generators, df_startups, windcurtailment, TotalCost_df, df_zonalwindproduction, df_zonalsolarproduction = results.optimization()
    ...
    return df_flow, df_price, df_zonalwindproduction, df_zonalsolarproduction, df_windprodload
