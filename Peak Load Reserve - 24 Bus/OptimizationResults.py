...
def optimization():
    ...
    # Cost of wind
    windcost = {}
    for z in ZonalPrices.columns:
        for t in ZonalPrices.index:
            windcost[z,t] = WindProd[z][t] * ZonalPrices[z][t]
    ...
    windpenlevel = WindLoad_df['WindPenetration[%]'].mean()
    
    return ZonalPrices, GeneratorProduction, LineFlow, LoadShed, WindLoad_df, Rev_Cost_df, network, times, generators, startup_number_df, WindCurtailment, TotalCost_df, windpenlevel, totalwindcost