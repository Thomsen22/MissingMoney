...
import capmarket_opt as cmmodel
...
class CapacityMarket:
    ...
    def _load_data(self):
        self.data.flow, self.data.df_price_DA, self.data.df_windprod, self.data.df_solarprod = cmmodel.DayAheadMarket() 
        self.data.cost = pd.read_csv('revenue_cost_gen.csv', sep=',', encoding='latin-1').set_index('Generator')
        ...
        self.data.timeperiod = 'Year' # Must be changed to Year
        ...
        self.data.cost.fillna(0, inplace=True)
