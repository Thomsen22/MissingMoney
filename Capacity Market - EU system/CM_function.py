...
def capacitymarketoptimization():
    ...
    return df_price, df_gencapacity, df_cost, df_capacityreq, df_generators, df_price_DA, totalwindcost, df_windprod, df_solarprod, df_zonalconsumption, zones, gens_for_zones, timeperiod
