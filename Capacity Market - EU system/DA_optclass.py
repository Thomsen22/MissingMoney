...
# This class makes the DA market for the European scale model
...
class DayAhead:
    ...
    def _load_data(self):
        ...
        self.data.hydrocoeff = 0.70 #0.473
        self.data.windscale = 0.60 # Between 0 and 1
        self.data.solarscale = 0.0 # Between 0 and 1
